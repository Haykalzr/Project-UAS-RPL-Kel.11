            ...
            <?php
              if (isset($_POST['aksi'])) {
                  if ($_POST['aksi'] == "add") {
                    ...
                    $inputKeterangan = $_POST['inputKeterangan'];

                    $query = "INSERT INTO mahasiswa VALUES('$inputNpm', '$inputNamaMhs', '$inputJurusan', '$inputKeterangan')";
                    ...
                    $query = "UPDATE mahasiswa SET npm='$inputNpm', nama='$inputNamaMhs', jurusan='$inputJurusan', keterangan='$inputKeterangan' WHERE npm='$inputNpm';";
                    $sql = mysqli_query($koneksi, $query);
